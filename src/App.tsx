    ...
    addBackgroundTask('تنسيق وتصدير ملف الأسماء PDF', async () => {
      ...
      container.innerHTML = `
        <div style="padding: 80px 50px; background-color: #0c0d12; color: white; min-height: 1100px;">
          ...
          <div style="margin-top: 100px; text-align: center; font-size: 14px; color: #475569; padding-top: 40px; border-top: 1px solid rgba(255,255,255,0.05); display: flex; flex-direction: column; align-items: center; gap: 8px;">
                 ...
                 <div>
                   <h2 className="text-xl font-black italic text-gray-900 dark:text-white leading-none">
                     {moreSubTab === 'birthday' ? 'عداد الميلاد' : 
                      ...
                      moreSubTab === 'docVault' ? 'المخزن السحابي وحافظة الوثائق' :
               ...
               {moreSubTab === 'ageDiff' && <AgeDiffTool />}
                ...
                {moreSubTab === 'docVault' && (
                  <DocVault 
                    ...
                    addBackgroundTask={addBackgroundTask} 
                    userPhone={userPhone} 
                    usernameUnified={birthdayProConfig.usernameUnified || 'guest'} 
                    theme={theme} 
                  />
                )}
      ...
      <div className="animate-in fade-in slide-in-from-right-4 duration-300 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          {[
            ...
            { id: 'docVault', label: 'أرشيف وحافظة المستندات', icon: HardDrive, color: 'text-indigo-600 dark:text-indigo-400', bg: 'bg-indigo-600/10' },
          ].map((service) => (
            <button
              key={service.id}
